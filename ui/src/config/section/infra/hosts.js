...
export default {
  ...
  columns: () => {
    const fields = [
      ...
      'version', 'version', 'haenable', 'hastate'
    ]
    const metricsFields = [{ field: 'systeminstances', customTitle: 'system.vms' }, 'instances', 'powerstate', 'cpunumber', 'cputotalghz', 'cpuusedghz', 'cpuallocatedghz', 'memorytotalgb', 'memoryusedgb', 'memoryallocatedgb', 'gputotal', 'gpuused', 'networkread', 'networkwrite']
  ...
  details: ['name', 'id', 'resourcestate', 'ipaddress', 'migrationip', 'hypervisor', 'externalprovisioner', 'arch', 'type', 'clustername', 'podname', 'zonename', 'storageaccessgroups', 'clusterstorageaccessgroups', 'podstorageaccessgroups', 'zonestorageaccessgroups', 'managementservername', 'disconnected', 'created', 'externaldetails'],
  tabs: [{
    name: 'details',
