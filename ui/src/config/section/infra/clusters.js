...
export default {
  ...
  columns: () => {
    ...
    const metricsFields = ['haenable', 'state', 'hosts', 'cpuused', 'cpumaxdeviation', 'cpuallocated', 'cputotal', 'memoryused', 'memorymaxdeviation', 'memoryallocated', 'memorytotal', 'drsimbalance']
