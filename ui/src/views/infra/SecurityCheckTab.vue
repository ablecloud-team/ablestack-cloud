...
export default {
  ...
  methods: {
    ...
    fetchData () {
      this.loading = true
      api('getSecurityCheckResult', { managementserverid: this.resource.id }).then(json => {
        console.log(json)
        this.securityChecks = json.getsecuritycheckresultresponse.securitychecks.securitychecks
      }).catch(error => {
