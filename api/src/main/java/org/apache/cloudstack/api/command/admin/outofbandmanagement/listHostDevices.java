...
@APICommand(name = "listHostDevices", description = "list vmPci'.", since = "4.20.0.0", responseObject = ListVMPciResponse.class, requestHasSensitiveInfo = false, responseHasSensitiveInfo = false, authorized = {
        RoleType.Admin })
