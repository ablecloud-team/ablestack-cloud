...
public class UpdateHostScsiDevicesResponse extends BaseResponse {
    ...
    public UpdateHostScsiDevicesResponse(String hostDevicesName, String virtualmachineid, boolean allocated) {
    this.hostDevicesName = hostDevicesName;
    this.virtualmachineid = virtualmachineid;
    this.allocated = allocated;
}

    public UpdateHostScsiDevicesResponse() {
        super();
