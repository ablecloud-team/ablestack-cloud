...
public class UpdateHostHbaDevicesResponse extends BaseResponse {
    ...
    public UpdateHostHbaDevicesResponse(String hostDevicesName, String virtualmachineid, boolean allocated) {
    this.hostDevicesName = hostDevicesName;
    this.virtualmachineid = virtualmachineid;
    this.allocated = allocated;
}

    public UpdateHostHbaDevicesResponse() {
        super();
        setObjectName("updatehosthbadevices");
    }
