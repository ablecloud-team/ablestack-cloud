...
@APICommand(name = "revertSnapshotBackup", description = "This is supposed to revert a volume snapshot. This command is only supported with KVM so far", responseObject = SnapshotResponse.class, entityType = {Snapshot.class},
        requestHasSensitiveInfo = false, responseHasSensitiveInfo = false)
public class RevertSnapshotBackupCmd extends BaseAsyncCmd {
    ...
    public void execute() {
        ...
        Snapshot snapshot = _snapshotService.revertSnapshot(getId(), getBackup());
        if (snapshot != null) {
