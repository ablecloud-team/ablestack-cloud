...
@ResourceWrapper(handles = UpdateHostUsbDeviceCommand.class)
public final class LibvirtupdateHostUsbDevicesCommandWrapper
        extends CommandWrapper<UpdateHostUsbDeviceCommand, Answer, LibvirtComputingResource> {
    @Override
