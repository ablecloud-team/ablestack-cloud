...
public class UpdateHostLunDeviceAnswer extends Answer {
    private boolean successMessage;
    private String vmName;
    private String xmlConfig;
    private boolean isAttach;

    public UpdateHostLunDeviceAnswer() {
        super();
    }

    public UpdateHostLunDeviceAnswer(boolean successMessage, String vmName, String xmlConfig, boolean isAttach) {
        super();
