...
public class UpdateHostScsiDeviceAnswer extends Answer {
    private boolean successMessage;
    private String vmName;
    private String xmlConfig;
    private boolean isAttach;

    public UpdateHostScsiDeviceAnswer() {
        super();
    }

    public UpdateHostScsiDeviceAnswer(boolean successMessage, String vmName, String xmlConfig, boolean isAttach) {
        super();
